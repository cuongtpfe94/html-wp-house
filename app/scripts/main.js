window.addEventListener('DOMContentLoaded', () => {
  ...
  class HeaderComponent {
    constructor() {
      ...
      this.drawerOverlay = document.querySelector(
    ...
    openMobileSearch() {
      ...
      const searchInput = this.searchMobile.querySelector(
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = { HeaderComponent, SidebarAccordion, AboutAccordion };
  }
});
